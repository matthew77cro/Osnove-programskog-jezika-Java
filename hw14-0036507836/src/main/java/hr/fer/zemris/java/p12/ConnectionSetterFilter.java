...
/**
 * Filter used for setting a connection from the connection pool for current incoming request.
 * @author Matija
 *
 */
@WebFilter(filterName="connectionSetterFilter",urlPatterns={"/servleti/*"})
