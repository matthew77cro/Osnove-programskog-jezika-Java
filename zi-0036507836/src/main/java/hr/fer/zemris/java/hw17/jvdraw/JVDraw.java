...
public class JVDraw extends JFrame {
	...
	private JToggleButton filledTriangle;
	...
	public JVDraw() {
		...
		states.put("filledTriangle", new FilledTriangleTool(model, fgColor, bgColor, canvas));
	...
	private void initGui() {
		...
		filledTriangle = new JToggleButton("Filled triangle");
		bgroup.add(line);
		bgroup.add(circle);
		bgroup.add(filledCircle);
		bgroup.add(filledTriangle);
	...
	private void initListeners() {
		...
		filledTriangle.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				JVDraw.this.currentState = states.get("filledTriangle");
			}
		});
