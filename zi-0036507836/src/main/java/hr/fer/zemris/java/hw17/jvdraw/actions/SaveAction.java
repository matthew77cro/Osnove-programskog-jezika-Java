...
/**
 * Action used for saving currently opened context into a jvd file.
 * @author Matija
 *
 */
...
public class SaveAction extends AbstractAction {
	 ...
	 */
	public SaveAction(String name, KeyStroke acceleratorKey, int mnemonicKey, String shortDescription, ActionContext context) {
		super(name);
