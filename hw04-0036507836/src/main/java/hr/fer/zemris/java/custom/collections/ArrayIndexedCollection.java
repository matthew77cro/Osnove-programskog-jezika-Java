...
public class ArrayIndexedCollection<E> implements List<E> {
	...
	public ElementsGetter<E> createElementsGetter() {
		return new ArrayIndexedCollectionGetter<E>(this);
	}
	
	//Used for implementing elementGetter so the collection can be iterated through
	private static class ArrayIndexedCollectionGetter<E> implements ElementsGetter<E> {
		
		private ArrayIndexedCollection<E> col;
		private int index;
		private long savedModificationCount;
		
		public ArrayIndexedCollectionGetter(ArrayIndexedCollection<E> col) {
			this.col = col;
			this.index = 0;
	...
	public int hashCode() {
		...
		result = prime * result + Objects.hash(capacity, modificationCount, size);
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		return capacity == other.capacity && Arrays.deepEquals(elements, other.elements)
				&& modificationCount == other.modificationCount && size == other.size;
	}
