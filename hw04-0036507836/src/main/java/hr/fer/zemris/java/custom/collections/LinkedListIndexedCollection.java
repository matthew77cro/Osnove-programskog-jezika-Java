...
public class LinkedListIndexedCollection<E> implements List<E> {
	...
	public int indexOf(Object value) {
		...
		ListNode<E> temporaryNode = first;
	...
	public boolean contains(Object value) {
		...
		for(ListNode<E> temporaryNode = first; temporaryNode!=null; temporaryNode=temporaryNode.next) {
	...
	public ElementsGetter<E> createElementsGetter() {
		return new LinkedListIndexedCollectionGetter<E>(this);
	}
	
	//Used for implementing elementGetter so the collection can be iterated through
	private static class LinkedListIndexedCollectionGetter<E> implements ElementsGetter<E> {

		private LinkedListIndexedCollection<E> col;
		private ListNode<E> node;
		private long savedModificationCount;
		
		public LinkedListIndexedCollectionGetter(LinkedListIndexedCollection<E> col) {
			this.col = col;
			this.node = col.first;
