...
class LinkedListIndexedCollectionTest {
	...
	static LinkedListIndexedCollection<String> c1;
	static LinkedListIndexedCollection<String> c2;
	static LinkedListIndexedCollection<String> c3;

	@BeforeEach
	void setUp() throws Exception {
		c1 = new LinkedListIndexedCollection<String>();
		c2 = new LinkedListIndexedCollection<String>();
		c2.add("0");
		c2.add("1");
		c2.add("2");
		c2.add("3");
		...
		c2.add("18");
		c2.add("19");
		c3 = new LinkedListIndexedCollection<String>(c2);
	}
