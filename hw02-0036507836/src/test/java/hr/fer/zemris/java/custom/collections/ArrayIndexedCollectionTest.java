...
class ArrayIndexedCollectionTest {
	...
	static ArrayIndexedCollection c1;
	static ArrayIndexedCollection c2;
	static ArrayIndexedCollection c3;
	static ArrayIndexedCollection c4;

	@BeforeEach
	void setUp() throws Exception {
		c1 = new ArrayIndexedCollection();
		c2 = new ArrayIndexedCollection(20);
		c2.add("0");
		c2.add("1");
		c2.add("2");
		c2.add("3");
		...
		c2.add("18");
		c2.add("19");
		c3 = new ArrayIndexedCollection(c2);
		c4 = new ArrayIndexedCollection(c2,10);
	}
