...
/**
 * Action that saves the currently opened document to the disk
 * @author Matija
 *
 */
public class SaveFileAction extends LocalizableAction{
	 ...
	 */
	public SaveFileAction(String key, ILocalizationProvider lp, KeyStroke acceleratorKey, int mnemonicKey, String shortDescription, MultipleDocumentModel documents, JFrame frame) {
		super(key, lp);
